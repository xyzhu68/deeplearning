...
model_Ci = None
if resnet:
    if drift_type == "appear" or drift_type == "transfer":
        model = load_model("model_base_resnet_digit0_4.h5")
    else:
        model = load_model("model_base_resnet.h5")

    if drift_type == "appear" or drift_type == "transfer" or drift_type == "remap":
        model_Ci = load_model("model_base_resnet_digit5_9.h5")
    else:
        model_Ci = load_model("model_base_resnet_{0}.h5".format(drift_type))
else:
    if drift_type == "appear" or drift_type == "transfer":
        model = load_model("model_base_digit0_4.h5")
    else:
        model = load_model("model_base.h5")

    if drift_type == "appear" or drift_type == "transfer" or drift_type == "remap":
        model_Ci = load_model("model_base_digit5_9.h5")
    else:
        model_Ci = load_model("model_base_{0}.h5".format(drift_type))
